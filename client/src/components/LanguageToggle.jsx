...
const LanguageToggle = () => {
  ...
  return (
    ...
    >
      <span className={`text-sm font-medium ${language === 'en' ? 'text-[#871f39] font-bold' : 'text-gray-500'}`}>
        EN
      </span>
      <span className="text-gray-300">|</span>
      <span className={`text-sm font-medium ${language === 'my' ? 'text-[#871f39] font-bold' : 'text-gray-500'}`}>
        MY
      </span>
    </button>
  );
