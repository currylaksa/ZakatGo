    ...
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
           ...
           <div className="mb-4 p-4 bg-gradient-to-r from-purple-50 to-[#fbe9ed] rounded-lg border border-purple-100">
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center"><HiOutlineNewspaper className="mr-2"/>Active & Approved Campaigns</h2>
            <div className="flex space-x-2 mb-4 overflow-x-auto py-2">
                ...
                <button className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap ${filter === 'waqf' ? 'bg-[#a62b45] text-white shadow-sm' : 'bg-gray-100 hover:bg-gray-200'}`} onClick={() => setFilter('waqf')}>Waqf</button>
